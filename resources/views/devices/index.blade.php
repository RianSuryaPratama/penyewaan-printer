...
<div class="container">
    ...
    <a href="{{ route('devices.create') }}" class="btn btn-primary mb-3">Tambah Perangkat</a>
    ...
    <form action="{{ route('devices.destroy', $device->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus perangkat ini?');">
        @csrf
        @method('DELETE')
